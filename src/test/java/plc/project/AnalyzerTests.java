    ...
    private static Stream<Arguments> testFunction() {
        return Stream.of(
                ...
                Arguments.of("No explicit return type",
                        // FUN empty() DO END
                        new Ast.Function("empty", Arrays.asList(), Arrays.asList(), Optional.empty(),
                                Arrays.asList()
                        ),
    ...
    private static Stream<Arguments> testLiteralExpression() {
        return Stream.of(
                ...
                Arguments.of("FALSE",
                        // "hello"
                        new Ast.Expression.Literal("FALSE"),
                        init(new Ast.Expression.Literal("FALSE"), ast -> ast.setType(Environment.Type.STRING))
                        )
        );
    }
        ...
        return Stream.of(
                Arguments.of("Decimal Multiplication",
                        ...
                        new Ast.Expression.Binary("*",
                                new Ast.Expression.Literal(BigDecimal.valueOf(2.5)),
                                new Ast.Expression.Literal(BigDecimal.valueOf(4.5))
                        ),
                        init(new Ast.Expression.Binary("*",
                                init(new Ast.Expression.Literal(BigDecimal.valueOf(2.5)), ast -> ast.setType(Environment.Type.DECIMAL)),
                                init(new Ast.Expression.Literal(BigDecimal.valueOf(4.5)), ast -> ast.setType(Environment.Type.DECIMAL))
